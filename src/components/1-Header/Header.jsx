...
export default function Header() {
  ...
  let [iconMoodColor, setIconMoodColoer] = useState("text-gray-600");
  useEffect(() => {
    if (dark) {
      document.documentElement.classList.add("dark");
      setIconMoodColoer("text-gray-400 ");
    ...
    <>
      ...
      >
        ...
        <button
          ...
          className="text-gray-700  dark:text-white text-xl  bg-[#fafafa] dark:bg-[#252529] rounded-full h-10 w-10 border-[1px] transition-all duration-200 dark:border-[#4a5565a6] border-gray-200  hover:border-gray-400 dark:hover:border-[#fff7ed54]"
        >
